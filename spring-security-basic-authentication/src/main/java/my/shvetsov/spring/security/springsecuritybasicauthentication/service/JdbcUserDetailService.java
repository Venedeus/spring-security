package my.shvetsov.spring.security.springsecuritybasicauthentication.service;
...
public class JdbcUserDetailService extends MappingSqlQuery<UserDetails> implements
    UserDetailsService {
